...
[...thumnails].forEach((thumbnail, index) => {
    thumbnail.addEventListener('click', () => {
        img_container.children[0].src = `../images/satelliteKitAssets/image-product-${index + 1}.png`;
...
modal_next.addEventListener('click', () => {
    if (image_index < 4) {
        ...
        image_index++;
        modal_img_container.children[1].src = `../images/satelliteKitAssets/image-product-${image_index}.png`
